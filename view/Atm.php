                ...
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            $sql = "SELECT atm.id, atm.location, atm.av_cash, atm.type, atm.status FROM atm";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    echo "<tr>
                                            ...
                                            <td>" . $row["type"] . "</td>
                                            <td>" . $row["status"] . "</td>
                                            <td><a href='../update&delete/update_atm.php?id=" . $row["id"] . "' class='btn btn-success'>Update</a></td>
                                            <td><a href='../update&delete/delete_atm.php?id=" . $row["id"] . "'' class='btn btn-danger'>Delete</a></td>
                                          </tr>";
                                }
                            } else {
