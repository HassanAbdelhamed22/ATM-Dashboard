                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    echo "<tr>
                                            ...
                                            <td>" . $row["address"] . "</td>
                                            <td><a href='../update&delete/update_user.php?id=" . $row["id"] . "' class='btn btn-success'>Update</a></td>
                                            <td><a href='../update&delete/delete_user.php?id=" . $row["id"] . "'' class='btn btn-danger'>Delete</a></td>
                                          </tr>";
                                }
                            } else {
