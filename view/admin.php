                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    echo "<tr>
                                            ...
                                            <td>" . $row["password"] . "</td>
                                            <td><a href='../update&delete/update_admin.php?id=" . $row["id"] . "' class='btn btn-success'>Update</a></td>
                                            <td><a href='../update&delete/delete_admin.php?id=" . $row["id"] . "'' class='btn btn-danger'>Delete</a></td>
                                          </tr>";
                                }
                            } else {
