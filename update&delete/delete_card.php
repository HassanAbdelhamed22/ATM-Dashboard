...
<div class="sidebar pe-4 pb-3">
    ...
    ?>
            ...
            <!-- Navbar End -->
            <form action="delete_card.php ?id_new=<?php echo $id; ?>" method="post">
    <div class="row g-3">
        <div class="col-md-6">
            <label for="exp_date" class="form-label">Expire Date</label>
            <input type="text" name="exp_date" class="form-control" id="exp_date"value="<?php echo $row['exp_date'] ?>">
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="acc_limit" class="form-control" id="acc_limit"value="<?php echo $row['acc_limit'] ?>">
        </div>
