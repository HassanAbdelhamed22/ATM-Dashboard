...
<div class="sidebar pe-4 pb-3">
    ...
    ?>
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="acc_number" class="form-control" id="acc_number"value="<?php echo $row['acc_number'] ?>">
        </div>
        <div class="col-md-6">
            <label for="phone" class="form-label">Balance</label>
            <input type="text" name="balance" class="form-control" id="balance"value="<?php echo $row['balance'] ?>">
        </div>
        <div class="col-md-6">
            <label for="last_tran_date" class="form-label">Last_Tran_Date</label>
            <input type="text" name="last_tran_date" class="form-control" id="last_tran_date"value="<?php echo $row['last_tran_date'] ?>">
        </div>
