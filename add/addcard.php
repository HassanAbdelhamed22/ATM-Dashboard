...
if(isset($_POST['submit'])){
    ...
    $acc_id = mysqli_real_escape_string($dbController->connection, $acc_id);
    $balance = mysqli_real_escape_string($dbController->connection, $balance);
    $user_id = mysqli_real_escape_string($dbController->connection, $user_id);
    $acc_limit = mysqli_real_escape_string($dbController->connection, $acc_limit);
    // Check for duplicate account number
    
    
        // Insert new data
        $query = "INSERT INTO card (acc_id, balance, user_id, acc_limit,exp_date) VALUES ('$acc_id', '$balance', '$user_id', '$acc_limit',DATE_ADD(NOW(), INTERVAL 1 YEAR))";
        ...
        <div class="col-sm-12 col-xl-6 w-100">
            <div class="bg-light rounded h-100 p-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="acc_id" class="form-label">Account ID</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="acc_limit" name="acc_limit">
                    </div>
