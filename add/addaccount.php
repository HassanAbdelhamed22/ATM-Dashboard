...
if(isset($_POST['submit'])){
    ...
    $acc_number = mysqli_real_escape_string($dbController->connection, $acc_number);
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        // Insert new data
        $query = "INSERT INTO account (acc_number, balance, user_id, last_tran_date) VALUES ('$acc_number', '$balance', '$user_id', NOW())";
        $result = mysqli_query($dbController->connection, $query);
        if(!$result){
    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-6 w-100">
            <div class="bg-light rounded h-100 p-4">
                ...
                <?php endif; ?>
                <?php if(isset($_SESSION['exist_msg'])): ?>
                    <div class="alert alert-danger" role="alert">
                        <?php echo $_SESSION['exist_msg']; ?>
                    </div>
                    <?php unset($_SESSION['exist_msg']); ?>
                <?php endif; ?>
                <form method="post">
                <div class="mb-3">
