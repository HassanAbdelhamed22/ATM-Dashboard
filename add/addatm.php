...
if(isset($_POST['submit'])){
    ...
    $location = mysqli_real_escape_string($dbController->connection, $location);
    $av_cash = mysqli_real_escape_string($dbController->connection, $av_cash);
    $Type = mysqli_real_escape_string($dbController->connection, $Type);
    $status = mysqli_real_escape_string($dbController->connection, $status);
        // Insert new data
        $query = "INSERT INTO atm (location, av_cash, type, status) VALUES ('$location', '$av_cash', '$Type', '$status')";
            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="av_cash" name="av_cash">
                    </div>
                    <div class="mb-3">
